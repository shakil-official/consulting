  ...
  return (
    <section className="py-24 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-700 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-1/3 w-80 h-80 bg-white/5 rounded-full blur-3xl"></div>
      </div>
            ...
            <div className="relative">
              ...
              <div className="text-center">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 inline-block">
                  <h4 className="text-2xl font-bold text-white mb-2">{currentClient.client}</h4>
                  <p className="text-blue-200 font-medium mb-1">{currentClient.position}</p>
                  <p className="text-blue-300 font-semibold mb-2">{currentClient.company}</p>
