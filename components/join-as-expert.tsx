            ...
            <div className="container mx-auto px-4 lg:px-6 relative">
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                        Join us as an{" "}
                        <span
                            className="bg-gradient-to-r from-blue-600 to-indigo-700 bg-clip-text text-transparent">Expert</span>
                    </h2>
                    <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                        We're always looking for experienced professionals passionate about resilience, crisis
                        management, and risk
                        leadership. Collaborate with a global team of specialists and make a real impact across
                        industries and
                        geographies.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                    {partnershipOptions.map((option, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className="bg-gradient-to-br from-gray-50 to-blue-50/30 border-2 border-transparent hover:border-blue-200 p-8 rounded-3xl hover:shadow-2xl transition-all duration-500 group hover:scale-105 relative overflow-hidden"
                            >
                                <div
                                ...
                                <div className="relative text-center">
                                    <div
                                        className="bg-gradient-to-br from-blue-600 to-indigo-700 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                ...
                <div
                    ...
                    <div className="relative text-center">
                        ...
                        <p className="text-blue-100 mb-8 max-w-3xl mx-auto text-lg leading-relaxed">
                            Bring your expertise where it matters most. Join our global network of resilience
                        ...
                        <div className="grid md:grid-cols-3 gap-6 mb-8">
                            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                                ...
                                <div className="text-blue-200">Connect with experts worldwide</div>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                                <div className="text-2xl font-bold mb-2">Real Impact</div>
                                <div className="text-blue-200">Work on meaningful projects</div>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                                <div className="text-2xl font-bold mb-2">Flexible Engagement</div>
                                <div className="text-blue-200">Choose your level of involvement</div>
                            </div>
                        </div>
