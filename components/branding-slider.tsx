            ...
            {duplicatedLogos.length > 0 ? (
                ...
                >
                    ...
                    <div className="absolute inset-0 pointer-events-none">
                        ...
                        <div
                            className="absolute bottom-0 right-1/4 w-80 h-80 bg-secondary/10 rounded-full blur-3xl floating"
                            style={{ animationDelay: "2s" }}
                        ></div>
                        <div
                            className="absolute top-1/2 left-0 w-64 h-64 bg-accent/10 rounded-full blur-3xl floating"
                    ...
                    >
                        {isLoading ? (
                            ...
                            <div
                                ...
                                style={{
                                    animation: isPlaying
                                        ? `scrollX ${speed}s linear infinite`
                                        : "none",
                                    width: `${duplicatedLogos.length * 300}px`, // closer to card width + gap
                                }}
                            >
