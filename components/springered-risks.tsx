...
export function SpringeredRisks() {
  return (
    <section id="risks" className="py-24 bg-gradient-to-br from-gray-50 to-blue-50/30 relative overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 mb-16">
          {springeredRisks.map((risk, index) => {
            ...
            return (
              <div
                key={index}
                className={`${risk.bgColor} border-2 border-transparent hover:border-blue-200 p-6 rounded-3xl hover:shadow-2xl transition-all duration-500 group hover:scale-105 relative overflow-hidden`}
              >
                {/* Background Gradient */}
                <div
              ...
              {[
                ...
                return (
                  <div key={index} className="text-center">
                    <div className="bg-gradient-to-br from-blue-600 to-indigo-700 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
